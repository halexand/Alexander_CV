...
cv.pdf: cv.tex publications.bib cv.bst cv.aux pending.bib presentations.bib publications.bib invitedpresentations.bib 
	TEXINPUTS="texmf:" pdflatex cv.tex
	bibtex cv
	bibtex pend
	bibtex pr
	...
	open cv.pdf -a /Applications/Preview.app
